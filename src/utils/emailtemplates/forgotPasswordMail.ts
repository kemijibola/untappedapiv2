                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                            <tr>
                                                <td valign="top" class="bodyContent" mc:edit="body_content">
                                                    ...
                                                    <p>Looks like you've forgotten your password! If so, click the button below to create a new password or copy and paste the link below into your address bar.</p>
                                                    <a href="[VerifyToken]" style="
                                                        ...
                                                        display: block;
                                                        margin-top: 25px;
                                                    "><span style="text-transform: uppercase;font-family: AvenirNextLTProBold;cursor: pointer;">Reset password</span></a>
