              ...
              <style type="text/css">
                  ...
                  */
                  h1{
                      ...
                      display:block;
                      /*@editable*/ font-family: AvenirNext-reg;
                                  ...
                                  <tr>
                                      <td align="center" valign="top">
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateHeader">
                                              <tr>
                                                  <td valign="top" class="headerContent" style="padding: 20px;">
                                          ...
                                          <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                              <tr>
                                                  <td valign="top" class="bodyContent" mc:edit="body_content">
                                                      <h1 style="text-align: center;font-weight: normal;font-size: 23px;">Welcome to <span style="font-family: AvenirNext-reg;letter-spacing: 2px; font-weight: bold">UntappedPool</span></h1>
                                                      
                                                      <p>My name is Oluwakemi, CEO and founder of UntappedPool. Thank you for signing up - we’re delighted to have you on board!</p>
                                                      ...
                                                      <br>
                                                      <br>
                                                     <p>Oluwakemi Awosile,</p>
                                                     <p>CEO, UntappedPool</p>
