                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                            <tr>
                                                <td valign="top" class="bodyContent" mc:edit="body_content">
                                                    <h1 style="text-align: center;font-weight: normal;font-size: 23px;">Congratulations [Name]</h1>
                                                    
                                                    <p>
                                You recently participated in a competition on our platform - <b>[ContestTitle]</b>. I am pleased to inform you that the competition has ended and you finished <b>[Position]</b>.
                                Your competition reward has been transfered to your wallet - <b>[WalletId]</b>.
                            </p>
                                                   <p>Best wishes,</p>
                                                   <span>Alice and the UntappedPool team</span>
                                                </td>
                                            </tr>
                                        </table>
                                        <!-- // END BODY -->
