                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%" id="templateBody">
                                            <tr>
                                                <td valign="top" class="bodyContent" mc:edit="body_content">
                                                    ...
                                                    <p>Please click the button below to verify your new email address.You may also copy and paste the link into your address bar.</p>
                                                    <a href="[VerifyToken]" style="
                                                        ...
                                                        display: block;
                                                        margin-top: 25px;
                                                    "><span style="text-transform: uppercase;font-family: AvenirNextLTProBold;cursor: pointer;">Verify Email</span></a>
