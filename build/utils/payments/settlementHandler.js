...
var SettlementHandler = /** @class */ (function () {
    ...
    SettlementHandler.initialize = function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        if (!(serviceType === interfaces_1.ServiceType.contest)) return [3 /*break*/, 2];
                        return [4 /*yield*/, this._contestRepository.findById(item)];
                    case 1:
                        updateObj = _a.sent();
                        if (updateObj) {
...
exports.SettlementHandler = SettlementHandler;
//# sourceMappingURL=settlementHandler.js.map