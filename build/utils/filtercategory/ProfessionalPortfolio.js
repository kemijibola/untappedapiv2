...
var ContestBusiness_1 = __importDefault(require("../../app/business/ContestBusiness"));
var ProfessionalPortfolio = /** @class */ (function () {
    function ProfessionalPortfolio(userId) {
        this.userId = userId;
    }
    ProfessionalPortfolio.setUp = function (userId) {
        return new ProfessionalPortfolio(userId);
    };
    ProfessionalPortfolio.prototype.fetchProfessionalContests = function () {
        return __awaiter(this, void 0, void 0, function () {
            var contests, contestBusiness, userContests;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (userContests.data)
                            contests = contests.concat(userContests.data);
                        return [2 /*return*/, contests];
                }
            });
        });
    };
...
//# sourceMappingURL=ProfessionalPortfolio.js.map