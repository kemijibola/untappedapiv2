    ...
    return function (target) {
        ...
        for (var key in target.prototype) {
            ...
            var requiredProps = Reflect.getMetadata(MetadataKeys_1.MetadataKeys.validator, target.prototype, key) ||
                [];
            var requestType = Reflect.getMetadata(MetadataKeys_1.MetadataKeys.requesttype, target.prototype, key) ||
                '';
            var validator = requestValidator_1.requestValidators(requestType, requiredProps);
            if (path) {
