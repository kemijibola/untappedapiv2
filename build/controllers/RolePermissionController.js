...
var RolePermissionController = /** @class */ (function () {
    ...
    RolePermissionController.prototype.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var item, rolePermissionBusiness, result, err_1;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        rolePermissionBusiness = new RolePermissionBusiness();
                        return [4 /*yield*/, rolePermissionBusiness.fetch({})];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                            return [2 /*return*/, next(new ApplicationError_1.PlatformError({
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], RolePermissionController.prototype, "fetch", null);
    RolePermissionController = __decorate([
        decorators_1.controller("/v1/role-permissions")
