...
var CategoryTypeController = /** @class */ (function () {
    ...
    CategoryTypeController.prototype.fetch = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var categoryTypeBusiness, result, err_1;
    ...
    CategoryTypeController.prototype.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var item, categoryTypeBusiness, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        item = req.body;
                        categoryTypeBusiness = new CategoryTypeBusiness_1.default();
                        return [4 /*yield*/, categoryTypeBusiness.create(item)];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                            return [2 /*return*/, next(new error_1.PlatformError({
    ...
    __decorate([
        ...
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], CategoryTypeController.prototype, "create", null);
    CategoryTypeController = __decorate([
        decorators_1.controller("/v1/categories-types")
