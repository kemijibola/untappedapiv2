...
var UserTypeController = /** @class */ (function () {
    ...
    UserTypeController.prototype.fetch = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var userTypeBusiness, result, err_1;
    ...
    UserTypeController.prototype.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var item, userTypeBusiness, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        item = req.body;
                        userTypeBusiness = new UserTypeBusiness();
                        return [4 /*yield*/, userTypeBusiness.create(item)];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                            return [2 /*return*/, next(new ApplicationError_1.PlatformError({
