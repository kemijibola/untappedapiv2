...
var OrderController = /** @class */ (function () {
    ...
    OrderController.prototype.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var item, orderBusiness, result, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, orderBusiness.create(item)];
                    case 1:
                        result = _a.sent();
                        if (result.error) {
                            orderBusiness;
    ...
    OrderController.prototype.verifyOrder = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var paymentFactory, verifiedPayment, orderBusiness, result, err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
    ...
    __decorate([
        ...
        decorators_1.requestValidators("service", "processor", "order"),
    ...
    __decorate([
        decorators_1.post("/:id/verify"),
        decorators_1.use(ValidateRequest_1.requestValidator),
        decorators_1.requestValidators("processor", "reference"),
        decorators_1.use(auth_1.requireAuth),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ...
    OrderController = __decorate([
        decorators_1.controller("/v1/orders"),
