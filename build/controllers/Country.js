...
var CountryRepository = require("../app/repository/CountryRepository");
var error_1 = require("../utils/error");
var CountryController = /** @class */ (function () {
    function CountryController() {
    }
    CountryController.prototype.create = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var item, countryModel, country, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (countryModel)
                            return [2 /*return*/, next(new error_1.RecordExists("Country with name " + countryModel.name + " exists.", 400))];
                        return [4 /*yield*/, new CountryRepository().create(item)];
                    case 3:
                        country = _a.sent();
