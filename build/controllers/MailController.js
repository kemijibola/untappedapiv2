...
var MailController = /** @class */ (function () {
    ...
    MailController.prototype.sendMail = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var recievers, mailer, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        recievers = [config.UNTAPPED_SUPPORT_EMAIL];
                        mailer = MailBusiness_1.MailBusiness.init();
                        return [4 /*yield*/, mailer.sendMail(req.body.senderEmail, req.body.senderName || req.body.senderEmail, recievers, req.body.subject || "", req.body.mailBody)];
                    case 1:
                        _a.sent();
    ...
    __decorate([
        decorators_1.post("/send"),
        decorators_1.use(ValidateRequest_1.requestValidator),
        decorators_1.requestValidators("senderEmail", "senderName", "subject", "mailBody"),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Object, Object, Function]),
        __metadata("design:returntype", Promise)
    ], MailController.prototype, "sendMail", null);
    MailController = __decorate([
        decorators_1.controller("/v1/mail"),
