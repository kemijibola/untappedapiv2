...
var Payment_1 = require("../data/schema/Payment");
var RepositoryBase_1 = __importDefault(require("./base/RepositoryBase"));
var PaymentRepository = /** @class */ (function (_super) {
    __extends(PaymentRepository, _super);
    function PaymentRepository() {
        return _super.call(this, Payment_1.PaymentSchema) || this;
    }
