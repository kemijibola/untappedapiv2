...
var ContestConfigBusiness = /** @class */ (function () {
    ...
    ContestConfigBusiness.prototype.fetch = function (condition) {
        return __awaiter(this, void 0, void 0, function () {
            var contestConfigs, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._contestConfigRepository.fetch(condition)];
                    case 1:
    ...
    ContestConfigBusiness.prototype.findByCriteria = function (criteria) {
        return __awaiter(this, void 0, void 0, function () {
            var contestConfig, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._contestConfigRepository.findByCriteria(criteria)];
                    case 1:
                        contestConfig = _a.sent();
                        if (!contestConfig)
                            return [2 /*return*/, Result_1.Result.fail(404, "Contest config not found")];
    ...
    ContestConfigBusiness.prototype.create = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            var newContestConfig, err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._contestConfigRepository.create(item)];
                    case 1:
    ...
    ContestConfigBusiness.prototype.update = function (id, item) {
        return __awaiter(this, void 0, void 0, function () {
            var contestConfig, updateObj, err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._contestConfigRepository.delete(id)];
                    case 1:
                        isDeleted = _a.sent();
