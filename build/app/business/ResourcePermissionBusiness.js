...
var ResourcePermissionBusiness = /** @class */ (function () {
    ...
    ResourcePermissionBusiness.prototype.update = function (id, item) {
        return __awaiter(this, void 0, void 0, function () {
            var resourcePermissionModel;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._resourcePermissionRepository.findById(id)];
                    case 1:
                        resourcePermissionModel = _a.sent();
                        if (!resourcePermissionModel)
                            throw new error_1.RecordNotFound("Resource Permission with id: " + id + " not found", 404);
                        return [2 /*return*/, this._resourcePermissionRepository.update(resourcePermissionModel._id, item)];
                }
            });
        });
    };
