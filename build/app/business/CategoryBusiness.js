...
var CategoryBusiness = /** @class */ (function () {
    ...
    CategoryBusiness.prototype.fetch = function (condition) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._categoryRepository.fetch(condition)];
                    case 1:
                        categories = _a.sent();
    ...
    CategoryBusiness.prototype.findOne = function (condition) {
        return __awaiter(this, void 0, void 0, function () {
            var category;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        category = _a.sent();
                        if (!category)
                            return [2 /*return*/, Result_1.Result.fail(404, "Category not found")];
                        return [2 /*return*/, Result_1.Result.ok(200, category)];
                }
            });
        });
    ...
    CategoryBusiness.prototype.findByCriteria = function (criteria) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._categoryRepository.findByCriteria(criteria)];
                    case 1:
                        category = _a.sent();
                        if (!category)
    ...
    CategoryBusiness.prototype.create = function (item) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._categoryRepository.findByCriteria({
                            name: item.name
                        })];
                    case 1:
                        category = _a.sent();
    ...
    CategoryBusiness.prototype.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._categoryRepository.delete(id)];
                    case 1:
                        isDeleted = _a.sent();
...
//# sourceMappingURL=CategoryBusiness.js.map