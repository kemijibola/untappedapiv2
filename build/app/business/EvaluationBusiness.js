        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        evaluationModel = _a.sent();
                        if (!evaluationModel)
                            throw new error_1.RecordNotFound("Evaluation with id: " + id + " not found", 404);
                        return [2 /*return*/, this._evaluationRepository.update(evaluationModel._id, item)];
                }
            });
        });
    };
