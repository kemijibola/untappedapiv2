...
var CommentBusiness = /** @class */ (function () {
    ...
    CommentBusiness.prototype.update = function (id, item) {
        return __awaiter(this, void 0, void 0, function () {
            var comment, updateObj, commenterDetails, likedBy, userReplies, _i, userReplies_1, reply, userId, replyCommenter, _a, likedBy_1, like, likedByUser, commentObj;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 8:
                        ...
                        like = likedBy_1[_a];
                        return [4 /*yield*/, this._userRepository.findById(like._id)];
                    case 9:
                        likedByUser = _b.sent();
