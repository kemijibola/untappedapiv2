...
var UserTypeBusiness = /** @class */ (function () {
    ...
    UserTypeBusiness.prototype.fetch = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._userTypeRepository.fetch()];
                    case 1:
                        userTypes = _a.sent();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        userType = _a.sent();
                        if (!userType._id)
                            return [2 /*return*/, Result_1.Result.fail(404, "User type of Id " + id + " not found")];
                        else
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._userTypeRepository.findByCriteria(criteria)];
                    case 1:
                        userType = _a.sent();
                        if (!userType._id)
                            return [2 /*return*/, Result_1.Result.fail(404, "User type not found")];
                        else
                            return [2 /*return*/, Result_1.Result.ok(200, userType)];
                        return [3 /*break*/, 3];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        userType = _a.sent();
                        if (!userType._id)
                            return [2 /*return*/, Result_1.Result.fail(404, "Could not update user type.User type of Id " + id + " not found")];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this._userTypeRepository.delete(id)];
                    case 1:
                        isDeleted = _a.sent();
